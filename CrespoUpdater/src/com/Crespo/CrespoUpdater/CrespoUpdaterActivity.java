...
/** Called when the activity is first created. */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		buttonTextView = (TextView) findViewById(R.id.CrespoUpdaterButton);
				...
				if (data != null) {
					...
					if (fileUri != null && !fileUri.toString().equals("")) {
						...
						if (filePath != null) {
							...
							try {
								checkDownloadedMD5.setAction(com.Crespo.CrespoUpdater.CrespoUpdaterActivity.checkMD5(filePath, true));
							} catch (IOException e) {
								// TODO Auto-generated catch block
								checkDownloadedMD5.setAction(com.Crespo.CrespoUpdater.CrespoUpdaterActivity.badFilePath());
							}
